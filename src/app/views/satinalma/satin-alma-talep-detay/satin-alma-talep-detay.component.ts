...
@Component({
  selector: 'app-satin-alma-talep-detay',
  templateUrl: './satin-alma-talep-detay.component.html',
  styleUrls: ['./satin-alma-talep-detay.component.scss'],
...
export class SatinAlmaTalepDetayComponent implements OnInit {
