...
@Component({
  selector: 'app-talep-kontrol-rapor',
  templateUrl: './talep-kontrol-rapor.component.html',
  styleUrls: ['./talep-kontrol-rapor.component.scss'],
...
export class TalepKontrolRaporComponent implements OnInit {
