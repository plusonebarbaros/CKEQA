...
@Component({
  selector: 'app-siparis-teslim',
  templateUrl: './siparis-teslim.component.html',
  styleUrls: ['./siparis-teslim.component.scss'],
...
export class SiparisTeslimComponent implements OnInit {
