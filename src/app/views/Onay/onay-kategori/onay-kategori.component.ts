...
@Component({
  selector: 'app-onay-kategori',
  templateUrl: './onay-kategori.component.html',
  styleUrls: ['./onay-kategori.component.scss'],
...
export class OnayKategoriComponent implements OnInit {
  ...
  constructor( 
    ...
    {  
      ...
      this.yetki = this.kulsrc.userperm.filter((x)=>x.YetkiKodu=="YT0014")[0];
    } 
  ...
  async kaydet(){   
      ...
      var sonuc = await this.onaysrc.OnayKategoriMasterEkle(this.secilidata,this.secilidata.Id > 0 ? IslemTipi.Guncelle : IslemTipi.Ekle);
