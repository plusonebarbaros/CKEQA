...
@Component({
  ...
  templateUrl: './kalite-giris-satinalma.component.html',
  styleUrls: ['./kalite-giris-satinalma.component.scss']
})
export class KaliteGirisSatinalmaComponent implements OnInit {
  ...
  async ngOnInit(): Promise<void> {  
      ...
      this.strMuhatapAdi = this.data.MuhatapAdi;
      this.strBelgeNo = this.data.strBelgeNo;
  ...
  this.senaryoList=[];
    ...
    if ( sonuc.List.length < 1) 
    {
      ...
      this.strMuhatapAdi = filteredItem.MuhatapAdi;
      this.strBelgeNo = filteredItem.BelgeNo;
